...
/*	
	...
	dónde la clase Permutacion es la vista en el problema 12 de la Relación 
	de Ejercicios IV --> La estructura de datos que soporta la permutación 
...
private:
	...
	// La estructura de datos empleada para guardar la permutación 
	// es un vector de la STL
	...
	/*****************************************************************/
	// Devuelve la posicion del mínimo elemento de la permutación. 
	...
	/*****************************************************************/
	// Devuelve la posicion del máximo elemento de la permutación. 
